...
def add_routes(listener: Listener, run_api: bool = True, run_webapp: bool = True):
    ...
    if run_webapp:
        ...
        listener.route("/logger_panel/view_endpoints")(webapp.view_endpoints)
        listener.route("/logger_panel/view_hosts")(webapp.view_hosts)
        listener.route("/logger_panel/hosts_by_endpoint")(webapp.html_hosts_by_endpoint)
        listener.route("/logger_panel/requests_by_endpoint")(webapp.html_requests_by_endpoint)
        listener.route("/logger_panel/requests_by_host")(webapp.html_requests_by_host)
        listener.route("/logger_panel/home")(webapp.home)
        listener.route("/logger_panel/search")(webapp.html_search)
        listener.route("/favicon.ico")(webapp.favicon)
        listener.route("/logger_panel/csv_dump")(webapp.csv_request_dump)
